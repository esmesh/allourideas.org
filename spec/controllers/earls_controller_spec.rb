  ...
  describe "GET :show" do
    before do
      ActiveResource::HttpMock.respond_to do |mock|
        ...
        mock.get "/questions/1.xml?user_identifier=1234567890&with_appearance=true&with_prompt=true&with_user_stats=true", {}, question, 200
        ...
        mock.post "/questions/1/prompts/1/vote.xml?next_prompt%5Buser_identifier%5D=test123&next_prompt%5Bwith_appearance%5D=true&next_prompt%5Bwith_user_stats%5D=true&question_id=1&vote%5Bappearance_lookup%5D=f72da54add43e5ca39cab80f1c72f0e7&vote%5Bdirection%5D=left&vote%5Bskip_fraud_protection%5D=true&vote%5Btime_viewed%5D=5&vote%5Btracking%5D%5Bx_click_offset%5D=&vote%5Btracking%5D%5By_click_offset%5D=&vote%5Buser_identifier%5D=test123", {}, prompt2, 200
      end
    ...
    it "sets a survey session cookie with a new cookie" do
      ...
      Click.last.session_info.session_id.should == assigns[:survey_session].session_id
    end
    ...
    it "sets a survey session cookie with the right data when passed a cookie" do
      ...
      assigns[:survey_session].session_id == session_id
      Click.last.session_info.session_id.should == session_id
    end
